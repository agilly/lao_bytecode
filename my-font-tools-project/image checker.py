...
for sublist in char_list:
    characters.extend(sublist)  # Add all characters from each sublist to the characters list
...
with open("bitmaps_for_char_list.h", "w", encoding="utf-8") as header_file:
